...
public class KillStreakQuestI extends Quest {
    private final KitPvP plugin;

    public KillStreakQuestI(KitPvP plugin) {
        super("Kill Streak I Quest", plugin);
        this.plugin = plugin;
    }
    ...
    public String getNextQuest() {
        return Quest.CLAN_QUEST.getName();
    }
